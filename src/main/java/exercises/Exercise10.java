...
/*
10. El NIF (o letra asociada a un DNI) se obtiene de la siguiente manera: Se divide el
número de DNI entre 23 y el resto es codificado por una letra según la siguiente
equivalencia:

0: "T", 1: "R", 2: "W", 3: "A", 4: "G", 5: "M", 6: "Y", 7: "F", 8: "P", 9:
"D",10:"X", 11: "B", 12: "N", 13: "J", 14: "Z", 15: "S", 16: "Q", 17: "V", 18:
"H", 19: "L", 20: "C", 21: "K", 22: "E".
...
public class Exercise10 {
    public static void main(String[] args) {
        ...
        System.out.print("Escribe tu numero de DNI (sin letra): ");
        int dni = sc.nextInt();

        System.out.println("Para el DNI " + dni + " el NIF es '" + letraDNI(dni) + "'");
    }

    public static char letraDNI(int numero) {


        char letra = (char) (numero % 23);
